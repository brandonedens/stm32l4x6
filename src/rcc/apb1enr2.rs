...
impl W {
    ...
    #[doc = "Bit 5 - LPTIM2EN"]
    #[inline]
    pub fn lptim2en(&mut self) -> _LPTIM2ENW {
        _LPTIM2ENW { w: self }
    }
    #[doc = "Bit 2 - Single wire protocol clock enable"]
    #[inline]
    pub fn swpmi1en(&mut self) -> _SWPMI1ENW {
        _SWPMI1ENW { w: self }
    }
    #[doc = "Bit 0 - Low power UART 1 clock enable"]
    #[inline]
