...
#[doc = r" Proxy"]
pub struct _LPTIM2RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _LPTIM2RSTW<'a> {
...
#[doc = r" Proxy"]
pub struct _SWPMI1RSTW<'a> {
    w: &'a mut W,
}
impl<'a> _SWPMI1RSTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - Low-power timer 2 reset"]
    #[inline]
    pub fn lptim2rst(&mut self) -> _LPTIM2RSTW {
        _LPTIM2RSTW { w: self }
    }
    #[doc = "Bit 2 - Single wire protocol reset"]
    #[inline]
    pub fn swpmi1rst(&mut self) -> _SWPMI1RSTW {
        _SWPMI1RSTW { w: self }
    }
    #[doc = "Bit 0 - Low-power UART 1 reset"]
    #[inline]
