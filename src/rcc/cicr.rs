...
#[doc = r" Proxy"]
pub struct _PLLSAI2RDYCW<'a> {
    w: &'a mut W,
}
impl<'a> _PLLSAI2RDYCW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _PLLSAI1RDYCW<'a> {
    w: &'a mut W,
}
impl<'a> _PLLSAI1RDYCW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn lsecssc(&mut self) -> _LSECSSCW {
        _LSECSSCW { w: self }
    }
    ...
    #[inline]
    pub fn pllsai2rdyc(&mut self) -> _PLLSAI2RDYCW {
        _PLLSAI2RDYCW { w: self }
    }
    #[doc = "Bit 6 - PLLSAI1 ready interrupt clear"]
    #[inline]
    pub fn pllsai1rdyc(&mut self) -> _PLLSAI1RDYCW {
        _PLLSAI1RDYCW { w: self }
    }
    ...
    #[inline]
    pub fn msirdyc(&mut self) -> _MSIRDYCW {
        _MSIRDYCW { w: self }
    }
