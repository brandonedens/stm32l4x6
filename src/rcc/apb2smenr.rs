...
#[doc = r" Proxy"]
pub struct _DFSDMSMENW<'a> {
    w: &'a mut W,
}
impl<'a> _DFSDMSMENW<'a> {
...
#[doc = r" Proxy"]
pub struct _TIM17SMENW<'a> {
    w: &'a mut W,
}
impl<'a> _TIM17SMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIM16SMENW<'a> {
    w: &'a mut W,
}
impl<'a> _TIM16SMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _TIM15SMENW<'a> {
    w: &'a mut W,
}
impl<'a> _TIM15SMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
#[doc = r" Proxy"]
pub struct _SDMMCSMENW<'a> {
    w: &'a mut W,
}
impl<'a> _SDMMCSMENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 24 - DFSDM timer clocks enable during Sleep and Stop modes"]
    #[inline]
    pub fn dfsdmsmen(&mut self) -> _DFSDMSMENW {
        _DFSDMSMENW { w: self }
    }
    #[doc = "Bit 22 - SAI2 clocks enable during Sleep and Stop modes"]
    #[inline]
    pub fn sai2smen(&mut self) -> _SAI2SMENW {
        _SAI2SMENW { w: self }
    }
    #[doc = "Bit 21 - SAI1 clocks enable during Sleep and Stop modes"]
    #[inline]
    ...
    #[doc = "Bit 18 - TIM17 timer clocks enable during Sleep and Stop modes"]
    #[inline]
    pub fn tim17smen(&mut self) -> _TIM17SMENW {
        _TIM17SMENW { w: self }
    }
    #[doc = "Bit 17 - TIM16 timer clocks enable during Sleep and Stop modes"]
    #[inline]
    ...
    #[doc = "Bit 13 - TIM8 timer clocks enable during Sleep and Stop modes"]
    #[inline]
    pub fn tim8smen(&mut self) -> _TIM8SMENW {
        _TIM8SMENW { w: self }
    }
    #[doc = "Bit 12 - SPI1 clocks enable during Sleep and Stop modes"]
    #[inline]
