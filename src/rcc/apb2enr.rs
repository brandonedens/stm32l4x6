...
#[doc = r" Proxy"]
pub struct _FIREWALLENW<'a> {
    w: &'a mut W,
}
impl<'a> _FIREWALLENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 10 - SDMMC clock enable"]
    #[inline]
    pub fn sdmmcen(&mut self) -> _SDMMCENW {
        _SDMMCENW { w: self }
    }
    #[doc = "Bit 7 - Firewall clock enable"]
    #[inline]
    pub fn firewallen(&mut self) -> _FIREWALLENW {
        _FIREWALLENW { w: self }
    }
    #[doc = "Bit 0 - SYSCFG clock enable"]
    #[inline]
