...
impl W {
    ...
    #[doc = "Bit 7 - Mux segment enable"]
    #[inline]
    pub fn mux_seg(&mut self) -> _MUX_SEGW {
        _MUX_SEGW { w: self }
    }
    #[doc = "Bit 8 - Voltage output buffer enable"]
    #[inline]
    pub fn bufen(&mut self) -> _BUFENW {
        _BUFENW { w: self }
    }
}
