...
impl W {
    ...
    #[doc = "Bit 15 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu15(&mut self) -> _PU15W {
        _PU15W { w: self }
    }
    #[doc = "Bit 14 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu14(&mut self) -> _PU14W {
        _PU14W { w: self }
    }
    #[doc = "Bit 13 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu13(&mut self) -> _PU13W {
        _PU13W { w: self }
    }
    #[doc = "Bit 12 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu12(&mut self) -> _PU12W {
        _PU12W { w: self }
    }
    #[doc = "Bit 11 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu11(&mut self) -> _PU11W {
        _PU11W { w: self }
    }
    #[doc = "Bit 10 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu10(&mut self) -> _PU10W {
        _PU10W { w: self }
    }
    #[doc = "Bit 9 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu9(&mut self) -> _PU9W {
        _PU9W { w: self }
    }
    #[doc = "Bit 8 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu8(&mut self) -> _PU8W {
        _PU8W { w: self }
    }
    #[doc = "Bit 7 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu7(&mut self) -> _PU7W {
        _PU7W { w: self }
    }
    #[doc = "Bit 6 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu6(&mut self) -> _PU6W {
        _PU6W { w: self }
    }
    #[doc = "Bit 5 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu5(&mut self) -> _PU5W {
        _PU5W { w: self }
    }
    #[doc = "Bit 4 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu4(&mut self) -> _PU4W {
        _PU4W { w: self }
    }
    #[doc = "Bit 3 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu3(&mut self) -> _PU3W {
        _PU3W { w: self }
    }
    #[doc = "Bit 2 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu2(&mut self) -> _PU2W {
        _PU2W { w: self }
    }
    #[doc = "Bit 1 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu1(&mut self) -> _PU1W {
        _PU1W { w: self }
    }
    #[doc = "Bit 0 - Port B pull-up bit y (y=0..15)"]
    #[inline]
    pub fn pu0(&mut self) -> _PU0W {
        _PU0W { w: self }
    }
}
